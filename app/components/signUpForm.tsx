...
const CustomSignUp = ({ isOpen, setIsOpen }: { isOpen: boolean; setIsOpen: (open: boolean) => void }) => {
                    ...
                    >
                        ...
                        >
                            ...
                            <div className="w-1/2 bg-[#6A5ACD] relative flex items-center justify-center">
                                <div className="absolute top-8 left-8 text-3xl font-bold text-black">Fiance Manager</div>
                                <div className="text-center">
                                    <h1 className="text-5xl font-bold text-black mb-4">
                                        MAKE YOUR <br /> BUDGET
                                    </h1>
                                    <p className="text-xl text-black">CONTROL YOUR BUDGET WISELY</p>
                                </div>
