  ...
  <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
    ...
    <div className="space-y-4">
      ...
      >
        ...
        <h2 className="text-xl font-bold text-[var(--foreground)]">Postcrafts</h2>
      </motion.div>
    ...
    {["Company", "Help", "Resources", "Extra Links"].map((section, index) => (
      ...
      >
        <h3 className="text-lg font-semibold text-[var(--foreground)]">{section}</h3>
        <ul className="mt-3 space-y-2 text-[var(--muted-foreground)]">
          ...
          {section === "Resources" &&
            ["Free eBooks", "Development Tutorial", "How to - Blog", "YouTube Playlist"].map(
              (item) => (
                <motion.li key={item} whileHover={{ scale: 1.05, x: 5 }}>
                  <a href="#" className="hover:text-[var(--primary)]">
                    {item}
