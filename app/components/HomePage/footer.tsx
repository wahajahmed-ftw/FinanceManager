  ...
  return (
    ...
    >
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="space-y-4">
          ...
          >
            ...
            <h2 className="text-xl font-bold text-white">Postcrafts</h2>
          </motion.div>
        ...
        {/* Links Section */}
        {["Company", "Help", "Resources", "Extra Links"].map((section, index) => (
          <motion.div
            key={index}
          ...
          >
            ...
            <ul className="mt-3 space-y-2 text-gray-300">
              ...
              {section === "Help" && ["Customer Support", "Delivery Details", "Terms & Conditions", "Privacy Policy"].map((item) => (
                <motion.li key={item} whileHover={{ scale: 1.05, x: 5 }}>
                  <a href="#" className="hover:text-blue-400">{item}</a>
                </motion.li>
              ))}
              ...
              {section === "Extra Links" && ["Customer Support", "Delivery Details", "Terms & Conditions", "Privacy Policy"].map((item) => (
                <motion.li key={item} whileHover={{ scale: 1.05, x: 5 }}>
                  <a href="#" className="hover:text-blue-400">{item}</a>
                </motion.li>
              ))}
      ...
      <div className="mt-10 flex flex-col items-center">
        <p className="text-gray-400">© Copyright 2021, All Rights Reserved by Postcraft</p>
        <motion.div
