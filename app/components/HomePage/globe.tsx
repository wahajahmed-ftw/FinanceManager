  ...
  return (
    ...
    >
      ...
      <div className="max-w-lg text-left absolute left-10">
        ...
        <p
          className="mt-6 text-xl z-30"
          style={{ color: "var(--muted-foreground)" }}
        >
          <TextAnimate animation="blurInUp" by="character" once>
            This finance management app helps users track expenses, manage
            income, and optimize their financial goals.
          </TextAnimate>
        </p>
      </div>
      ...
      <div className="max-w-lg text-right absolute right-10">
        ...
        >
          <TextAnimate animation="blurInUp" by="character" once>
            Stay ahead with real-time financial insights and seamless money
